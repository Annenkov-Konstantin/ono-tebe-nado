...
[🔗 Посмотреть демо (Desktop)](https://annenkov-konstantin.github.io/ono-tebe-nado/) • [🎨 Макет в Figma](https://www.figma.com/design/6POyOfIrRoH3msdtO7GjDL/%D0%9E%D0%BD%D0%BE-%D1%82%D0%B5%D0%B1%D0%B5-%D0%BD%D0%B0%D0%B4%D0%BE--Copy-?node-id=0-1&t=1D3fcgbSmtZiiSUs-1)
...
- Точное позиционирование элементов с помощью `z-index` и абсолютного позиционирования для создания эффекта наложения (оверлеи).

### 2. Pixel-Perfect и работа с пространством

- Отклонение от макета составляет менее **5px**.
